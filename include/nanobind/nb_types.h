...
public:
    NB_OBJECT(true_, object, "typing.Literal[True]", is_true)
...
public:
    NB_OBJECT(false_, object, "typing.Literal[False]", is_false)
...
public:
    NB_OBJECT(none, object, "typing.Literal[None]", is_none)
